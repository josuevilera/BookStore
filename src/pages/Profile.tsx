...
function Profile() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-l from-indigo-100 via-pink-100 to-yellow-100 flex flex-col items-center">
      <h2 className="text-xl font-bold text-center mb-10 pt-10">Tu perfil</h2>
      <p className="font-bold text-center">Aquí puedes gestionar tus libros.</p>

      <form
        className="flex flex-col gap-4 w-80 pt-10 mb-10 mx-auto"
        onSubmit={handleSubmit(onSubmit)}
      >
        <h3 className="text-lg font-semibold text-center">Actualizar Datos</h3>
